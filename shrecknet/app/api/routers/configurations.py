...
def get_config_schema() -> dict[str, Any]:
    ...
    group_definitions: list[dict[str, Any]] = [
        ...
        {"id": "architect", "label": "Architect Agent", "fields": ["model_architect_scene_chunking", "model_architect", "model_architect_entity_proposal", "model_architect_milestone_proposal", "model_architect_entity_generation", "model_agents_repair_json"]},
        ...
        {"id": "novelist", "label": "Novelist Agent", "fields": ["model_novelist", "model_novelist_draft", "model_novelist_planning", "model_novelist_prose", "model_novelist_critic"]},
