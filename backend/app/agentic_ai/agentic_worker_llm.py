...
async def generate_process_chunk_worker(
    ...
    system_prompt = (
        ...
        "3. 'relationships': a list of relationships, if any, with relationship_type, target_page (name from the text), direction (default 'outgoing'), and description. Return at most one relationship per target page and choose the most relevant if multiple are possible.\n"
