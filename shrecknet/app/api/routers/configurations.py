...
def get_config_schema() -> dict[str, Any]:
    ...
    group_definitions: list[dict[str, Any]] = [
        ...
        {"id": "architect", "label": "Architect Agent", "fields": ["model_architect_scene_chunking", "model_architect"]},
        ...
        {"id": "novelist", "label": "Novelist Agent", "fields": ["model_novelist", "model_novelist_draft"]},
