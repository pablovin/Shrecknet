...
def _settings(elder: str = "shared", librarian: str = "shared") -> SimpleNamespace:
    return SimpleNamespace(
        ...
        model_elder_planner=LLMModelTarget(provider="ollama", name=elder),
        model_elder_synthesis=LLMModelTarget(provider="ollama", name=elder),
        model_librarian_planner=LLMModelTarget(provider="ollama", name=librarian),
        model_librarian_synthesis=LLMModelTarget(provider="ollama", name=librarian),
