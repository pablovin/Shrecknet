...
def _get_old_database_url() -> str:
    settings = get_settings()
    return settings.old_database_url


async def get_old_db_session():
    """Create a session for the old database."""
    engine = create_async_engine(_get_old_database_url(), echo=False)
...
async def import_users(
    ...
    try:
        ...
        old_engine = create_async_engine(_get_old_database_url(), echo=False)
