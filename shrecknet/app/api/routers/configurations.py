...
SETTINGS_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            "semantic_embedding_strategy",
            "semantic_embedding_version",
            "semantic_embedding_long_text_threshold_tokens",
            "semantic_embedding_chunk_target_tokens",
            ...
            "character_agent_embodiment_scene_batch_size",
...
FIELD_UI_META: dict[str, dict[str, Any]] = {
    ...
    "model_elder_synthesis": {"type": "llm_target", "help": "Provider/model target for Elder answer synthesis."},
    "model_elder_character_incorporation": {"type": "llm_target", "help": "Provider/model target for Elder language and character rendering."},
    ...
    "semantic_embedding_strategy": {"type": "string", "help": "Active scene-memory semantic embedding strategy."},
    "semantic_embedding_version": {"type": "string", "help": "Semantic renderer/version identifier used for freshness."},
    "semantic_embedding_long_text_threshold_tokens": {"type": "integer", "help": "Token threshold for entity long-text documents."},
    "semantic_embedding_chunk_target_tokens": {"type": "integer", "help": "Target token budget including semantic context."},
    "semantic_embedding_chunk_overlap_tokens": {"type": "integer", "help": "Tokenizer-window overlap for lossless fallback splitting."},
    ...
    "model_character_agent_framing": {"type": "llm_target", "help": "Provider/model target for CharacterAgent task framing."},
    "model_character_agent_deliberation": {"type": "llm_target", "help": "Provider/model target for CharacterAgent deliberation."},
    ...
    "model_character_agent_scene_interpretation": {"type": "llm_target", "help": "Provider/model target for scene psychological enrichment and cross-scene observations."},
    "model_character_agent_update": {"type": "llm_target", "help": "Provider/model target for CharacterAgent axis, aspect, and goal updates."},
    "character_agent_embodiment_evidence_tokens": {"type": "integer", "help": "Scene chunk budget estimated at four characters per configured token; legacy evidence previews use ten."},
    "character_agent_embodiment_max_aspects": {"type": "integer", "help": "Maximum active aspects retained in an embodiment profile."},
    "character_agent_embodiment_max_goals": {"type": "integer", "help": "Maximum active goals retained in an embodiment profile."},
    "character_agent_embodiment_scene_batch_size": {"type": "integer", "help": "Maximum scenes per chronological source chunk (1–10). Chunks execute sequentially with four normal LLM calls each."},
...
def get_config_schema() -> dict[str, Any]:
    ...
    group_definitions: list[dict[str, Any]] = [
        ...
        {"id": "character_agent", "label": "Character Agent", "fields": ["model_character_agent_framing", "model_character_agent_deliberation", "model_character_agent_character_incorporation", "model_character_agent_scene_interpretation", "model_character_agent_update", "character_agent_embodiment_evidence_tokens", "character_agent_embodiment_max_aspects", "character_agent_embodiment_max_goals", "character_agent_embodiment_scene_batch_size"]},
