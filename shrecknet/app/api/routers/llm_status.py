...
async def get_service_status(
    ...
    return {
        ...
        "model_targets": {
            ...
            "model_elder_planner": _target_status(settings.model_elder_planner),
            "model_elder_synthesis": _target_status(settings.model_elder_synthesis),
            "model_elder_character_incorporation": _target_status(getattr(settings, "model_elder_character_incorporation", settings.model_elder_synthesis)),
            ...
            "model_character_agent_framing": _target_status(getattr(settings, "model_character_agent_framing", settings.model_elder_planner)),
