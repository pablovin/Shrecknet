...
SETTINGS_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            "character_agent_embodiment_debug_artifacts_enabled",
...
def get_config_schema() -> dict[str, Any]:
    ...
    group_definitions: list[dict[str, Any]] = [
        ...
        {"id": "character_agent", "label": "Character Agent", "fields": ["model_character_agent_framing", "model_character_agent_deliberation", "model_character_agent_character_incorporation", "model_character_agent_scene_interpretation", "model_character_agent_update", "character_agent_embodiment_evidence_tokens", "character_agent_embodiment_max_aspects", "character_agent_embodiment_max_goals", "character_agent_embodiment_debug_artifacts_enabled"]},
