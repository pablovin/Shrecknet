...
FIELD_UI_META: dict[str, dict[str, Any]] = {
    ...
    "novelist_scene_pipeline_batch_size": {"type": "integer", "help": "Novelist per-run scene batch size for steps 2-5 fanout."},
    "novelist_scene_pipeline_max_concurrency": {"type": "integer", "help": "Novelist max parallel scene pipelines per run."},
