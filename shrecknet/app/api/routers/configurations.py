...
FIELD_UI_META: dict[str, dict[str, Any]] = {
    ...
    "model_character_agent_verification": {"type": "llm_target", "help": "Provider/model target for CharacterAgent grounding verification and rendering."},
    "model_character_agent_embodiment": {"type": "llm_target", "help": "Provider/model target shared by CharacterAgent embodiment interpretation and proposal."},
...
def get_config_schema() -> dict[str, Any]:
    ...
    group_definitions: list[dict[str, Any]] = [
        ...
        {"id": "character_agent", "label": "Character Agent", "fields": ["model_character_agent_framing", "model_character_agent_deliberation", "model_character_agent_verification", "model_character_agent_embodiment", "character_agent_embodiment_evidence_tokens", "character_agent_embodiment_max_aspects", "character_agent_embodiment_max_goals"]},
