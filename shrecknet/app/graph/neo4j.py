...
async def ensure_character_graph_constraints(session: AsyncSession) -> None:
    ...
    statements = [
        ...
        "CREATE CONSTRAINT character_identity_revision_id_unique IF NOT EXISTS FOR (n:CharacterIdentityRevision) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT character_identity_revision_number_unique IF NOT EXISTS FOR (n:CharacterIdentityRevision) REQUIRE (n.character_agent_id, n.revision_number) IS UNIQUE",
        "CREATE CONSTRAINT character_identity_change_id_unique IF NOT EXISTS FOR (n:CharacterIdentityChange) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT scene_perspective_id_unique IF NOT EXISTS FOR (n:ScenePerspective) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT scene_perspective_owner_scene_unique IF NOT EXISTS FOR (n:ScenePerspective) REQUIRE (n.character_agent_id, n.scene_id) IS UNIQUE",
        "CREATE CONSTRAINT emotional_interpretation_id_unique IF NOT EXISTS FOR (n:EmotionalInterpretation) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT character_belief_id_unique IF NOT EXISTS FOR (n:CharacterBelief) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT character_impact_id_unique IF NOT EXISTS FOR (n:CharacterImpact) REQUIRE n.id IS UNIQUE",
        ...
        "CREATE INDEX character_identity_revision_agent_idx IF NOT EXISTS FOR (n:CharacterIdentityRevision) ON (n.character_agent_id)",
        "CREATE INDEX character_identity_change_agent_idx IF NOT EXISTS FOR (n:CharacterIdentityChange) ON (n.character_agent_id)",
        "CREATE INDEX character_aspect_name_idx IF NOT EXISTS FOR (n:CharacterAspect) ON (n.ontology_id, n.normalized_name)",
        "CREATE INDEX scene_perspective_scope_idx IF NOT EXISTS FOR (n:ScenePerspective) ON (n.ontology_id)",
        "CREATE INDEX scene_perspective_agent_idx IF NOT EXISTS FOR (n:ScenePerspective) ON (n.character_agent_id)",
        "CREATE INDEX scene_perspective_scene_idx IF NOT EXISTS FOR (n:ScenePerspective) ON (n.scene_id)",
        "CREATE INDEX emotional_interpretation_scope_idx IF NOT EXISTS FOR (n:EmotionalInterpretation) ON (n.ontology_id)",
        "CREATE INDEX character_belief_scope_idx IF NOT EXISTS FOR (n:CharacterBelief) ON (n.ontology_id)",
        "CREATE INDEX character_impact_scope_idx IF NOT EXISTS FOR (n:CharacterImpact) ON (n.ontology_id)",
    ]
    for statement in statements:
        await session.run(statement)
