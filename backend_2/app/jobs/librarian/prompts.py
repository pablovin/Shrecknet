...
4. For EVERY piece of information you use, wrap the cited text in this Markdown format: [text]{{cite library_item_id=ID library_item_name="BOOK_TITLE" page=PAGE}}
...
- Every fact, quote, or piece of information from the excerpts MUST be wrapped as: [text]{{cite library_item_id=ID library_item_name="BOOK_TITLE" page=PAGE}}
- Include library_item_id, library_item_name (book title), and page in every cite wrapper
